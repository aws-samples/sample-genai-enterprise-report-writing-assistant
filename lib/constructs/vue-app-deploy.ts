...
export interface VueAppProps {
  readonly kmsKey: Key;
  readonly vueAppBucket: IBucket;
}

export class VueAppDeploy extends Construct {
  ...
  constructor(scope: Construct, id: string, props: VueAppProps) {
    ...
    this.updateS3BucketPolicy(props.vueAppBucket, cloudFrontDistribution);

    this.cloudFrontDistributionUrl = cloudFrontDistribution.distributionDomainName
  ...
  private createCloudFrontDistribution(
    ...
    const distribution = new Distribution(this, "CloudFrontDistribution", {
      ...
      defaultBehavior: {
        ...
        origin: aws_cloudfront_origins.S3BucketOrigin.withOriginAccessControl(vueAppBucket, {
  ...
  private addCloudFrontOriginAccessControl(): string {
    const oac = new CfnOriginAccessControl(this, "OriginAccessControl", {
      originAccessControlConfig: {
        name: "vue-writing-assistant-oac",
  ...
  private updateS3BucketPolicy(
    ...
    const bucketPolicy = new PolicyStatement({
      ...
      resources: [`${vueAppBucket.bucketArn}/*`],
      conditions: {
        StringEquals: {
          "AWS:SourceArn": `arn:aws:cloudfront::${Aws.ACCOUNT_ID}:distribution/${cloudFrontDistribution.distributionId}`,
        },
    ...
    vueAppBucket.addToResourcePolicy(bucketPolicy);
  }
  ...
  private createCloudFrontDistributionOutput(
    ...
    new CfnOutput(this, "CloudFrontDistributionUrl", {
      ...
      description: "The CloudFront URL for the Vue App",
    });
  }
}
